...
const DiamondList = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      const res = await axios.get("https://thejewelhouse.com/backend/api/diamonds/download", { responseType: "blob" });
  ...
  const handleImport = async (e) => {
    ...
    try {
      ...
      await axios.post("https://thejewelhouse.com/backend/api/diamonds/import", formData, {
